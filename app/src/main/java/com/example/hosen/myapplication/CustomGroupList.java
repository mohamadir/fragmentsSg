...
public class CustomGroupList extends ArrayAdapter<String> {
    ...
    public CustomGroupList(Activity context, String[] titleArray, String[] reviewArray, String[] ratingArray, Integer[] imageId, String[] destinationArray, String[] descriptionArray,
        ...
        super(context, R.layout.group_item, titleArray);
